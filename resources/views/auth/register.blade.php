                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Akses E-Kavling sekarang</p>
                                    </div>
                                    ...
                                    <form class="needs-validation mt-4 pt-2" novalidate method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-4 form-floating form-floating-custom">
                                                    <input type="tel" id="contact-input"
                                                        ...
                                                        name="contact" placeholder=" " value="{{ old('contact') }}"
                                                        pattern="[0-9]{12}" required>
                                                    <label for="contact-input" class="form-label">Nomor Telepon</label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4 form-floating form-floating-custom">
                                                    <textarea id="progresspill-address-input" class="form-control @error('address') is-invalid @enderror" name="address"
                                        ...
                                        <div class="mb-4">
                                            <p class="mb-0">Dengan mendaftar anda setuju <a href="#"
                                                    class="text-primary">Kebijakan kami</a></p>
                                        </div>
                                        <div class="mb-3">
...
@endsection
@section('script')
    {{-- script untuk input no telp --}}
    <script>
        document.getElementById('contact-input').addEventListener('input', function(e) {
            this.value = this.value.replace(/[^0-9]/g, ''); // Hapus karakter non-numerik
        });
    </script>
