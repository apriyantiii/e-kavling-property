...
@section('title')
    Edit Pembayaran {{ $inhousePaymentId->name }}
@endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            Pembayaran {{ $inhousePaymentId->name }}
        @endslot
    @endcomponent
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation mt-0 pt-2" novalidate method="POST"
                        action="{{ route('checkout.inhouse-payment.update', $inhousePaymentId->id) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control form-rounded @error('payment_type') is-invalid @enderror"
                                        name="payment_type" id="payment_type" placeholder="Masukkan Tipe Pembayaran"
                                        value="{{ $inhousePaymentId->payment_type }}">
                                    @error('payment_type')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $inhousePaymentId->home_bank }}">
                                    @error('home_bank')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $inhousePaymentId->rekening_name }}">
                                    @error('rekening_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file"
                                        ...
                                        value="{{ $inhousePaymentId->transfer }}">
                                    @error('transfer')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="nice-select default-select wide form-control solid" name="tenor">
                                        //onchange="this.form.submit()
                                        <option value="6
                                        bln"
                                        {{ $inhousePaymentId->tenor === '6 bln' ? 'selected' : '' }}>
                                        6 Bulan
                                        </option>
                                        <option value="1 thn"
                                            {{ $inhousePaymentId->tenor === '1 thn' ? 'selected' : '' }}>
                                            1 Tahun
                                        </option>
                                        <option value="2 thn"
                                            {{ $inhousePaymentId->tenor === '2 thn' ? 'selected' : '' }}>
                                            2 Tahun</option>
                                        <option value="3 thn"
                                            {{ $inhousePaymentId->tenor === '3 thn' ? 'selected' : '' }}>
                                            3 Tahun</option>
                                        <option value="4 thn"
                                            {{ $inhousePaymentId->tenor === '4 thn' ? 'selected' : '' }}>
                                            4 Tahun</option>
                                        <option value="5 thn"
                                            {{ $inhousePaymentId->tenor === '5 thn' ? 'selected' : '' }}>
                                            5 Tahun</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control form-rounded @error('payment_date') is-invalid @enderror"
                                        ...
                                        value="{{ $inhousePaymentId->payment_date }}">
                                    @error('payment_date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="nice-select default-select wide form-control solid" name="status">
                                        ...
                                        {{ $inhousePaymentId->status === 'pending' ? 'selected' : '' }}>
                                        Pending
                                        </option>
                                        <option value="approved"
                                            {{ $inhousePaymentId->status === 'approved' ? 'selected' : '' }}>
                                            Disetujui
                                        </option>
                                        <option value="rejected"
                                            {{ $inhousePaymentId->status === 'rejected' ? 'selected' : '' }}>
                                            Ditolak</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $inhousePaymentId->destination_bank }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ $inhousePaymentId->nominal }}">
                                    @error('nominal')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control form-rounded @error('payment_description') is-invalid @enderror"
                                        ...
                                        rows="3">
@if ($inhousePaymentId->payment_description)
{{ $inhousePaymentId->payment_description }}
@else
