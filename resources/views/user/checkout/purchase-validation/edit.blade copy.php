                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-shipping" role="tabpanel"
                                    ...
                                    <div>
                                        ...
                                        <form method="POST"
                                            action="{{ route('purchase.updatePurchaseValidation', $purchaseValidation->id) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $purchaseValidation->name }}" required
                                                            autocomplete="name">
                                                        @error('name')
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $purchaseValidation->job }}" required
                                                            autocomplete="job">
                                                        @error('job')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $purchaseValidation->telpon }}" required
                                                            autocomplete="telpon">
                                                        @error('telpon')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ $purchaseValidation->nik }}" required
                                                            autocomplete="nik">
                                                        @error('nik')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="text-end">
                                                        <button type="submit" class="btn btn-success"><i
                                                                class= "bx bx-book-content me-1"></i> Edit
                                                            Validasi</button>
                                                    </div>
                                                </div> <!-- end col -->
                                            </div> <!-- end row -->
